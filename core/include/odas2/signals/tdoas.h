...
typedef struct tau_t {
    ...
    float delay;                    /**< Delay in samples (real number). */
    float amplitude;                /**< Amplitude that corresponds to the delay. */
...
typedef struct tdoas_t {
    ...
    tau_t * buffer;                 /**< Array of taus, for all sources. */
    tau_t ** taus;                  /**< Array of pointers. Each pointer links to the array of taus for all pairs, for a specific source. */
