...
int test_steering(void) {
...

    {
        ...
        doas->dirs[0] = (dir_t) { .coord = (xyz_t) { .x = -1.000, .y = +0.000, .z = +0.000 }, .energy = 0.10, .tracking_id = 0 };
        doas->dirs[1] = (dir_t) { .coord = (xyz_t) { .x = +0.000, .y = -1.000, .z = +0.000 }, .energy = 0.10, .tracking_id = 0 };
        doas->dirs[2] = (dir_t) { .coord = (xyz_t) { .x = +0.707, .y = +0.707, .z = +0.000 }, .energy = 0.10, .tracking_id = 0 };
