...
int test_steering(void) {
...

    {
        ...
        doas->dirs[0] = (dir_t) { .coord = (xyz_t) { .x = -1.000f, .y = +0.000f, .z = +0.000f }, .energy = 0.10f, .tracking_id = 0 };
        doas->dirs[1] = (dir_t) { .coord = (xyz_t) { .x = +0.000f, .y = -1.000f, .z = +0.000f }, .energy = 0.10f, .tracking_id = 0 };
        doas->dirs[2] = (dir_t) { .coord = (xyz_t) { .x = +0.707f, .y = +0.707f, .z = +0.000f }, .energy = 0.10f, .tracking_id = 0 };
