...
int test_mics(void) {
...

    {
        ...
        mics_t * mics1 = mics_construct(MICS_HARDWARE_RESPEAKER_USB_4);
        mics_t * mics2 = mics_construct(MICS_HARDWARE_RESPEAKER_USB_6);
        mics_t * mics3 = mics_construct(MICS_HARDWARE_MINIDSP_UMA);
